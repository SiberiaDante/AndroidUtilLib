...
public class SDToastUtil {
    ...
    public static void toast(CharSequence content) {
        if (mCustomToast == null) {
            mCustomToast = Toast.makeText(SDAndroidLib.getContext(), "", Toast.LENGTH_LONG);
        }
    ...
    private static Toast showSingleToastBottom(String content, int duration) {
        if (null == mToastBottom) {
            mToastBottom = Toast.makeText(SDAndroidLib.getContext(), "", Toast.LENGTH_LONG);
        }
    ...
    private static Toast showSingleToastCenter(String content, int duration) {
        if (null == mToastCenter) {
            mToastCenter = Toast.makeText(SDAndroidLib.getContext(), "", Toast.LENGTH_LONG);
        }
    ...
    private static Toast showSingleToastTop(String content, int duration) {
        if (null == mToastTop) {
            mToastTop = Toast.makeText(SDAndroidLib.getContext(), "", Toast.LENGTH_LONG);
        }
    ...
    private static Toast showTranslucentText(String content, int duration, float textSize, int textColor) {
        ...
        toastList.add(toast);
        LinearLayout linearLayout = new LinearLayout(SDAndroidLib.getContext());//创建线性布局
    ...
    private static Toast showView(@LayoutRes int resId, int position, int xOffset, int yOffset, int duration) {
        if (null == mToastView) {
            mToastView = Toast.makeText(SDAndroidLib.getContext(), "", Toast.LENGTH_LONG);
        }
        View view = LayoutInflater.from(SDAndroidLib.getContext()).inflate(resId, null);
    ...
    public static void showSingletonImageCenter(int resId, int duration) {
        ...
        ImageView imageView = new ImageView(SDAndroidLib.getContext());
    ...
    public static void showImageCenter(int resId, int duration) {
        toast = Toast.makeText(SDAndroidLib.getContext(), "", Toast.LENGTH_LONG);
        toastList.add(toast);
        ImageView imageView = new ImageView(SDAndroidLib.getContext());//创建图片控件
    ...
    public static void showImage(Bitmap bitmap, int duration, int position) {
        toast = Toast.makeText(SDAndroidLib.getContext(), "", duration);
        toastList.add(toast);
        ImageView imageView = new ImageView(SDAndroidLib.getContext());//创建图片控件
    ...
    public static void normal(@NonNull String message) {
        normal(SDAndroidLib.getContext(), message, Toast.LENGTH_SHORT, null, false).show();
    }
    ...
    public static void normal(@NonNull String message, Drawable icon) {
        normal(SDAndroidLib.getContext(), message, Toast.LENGTH_SHORT, icon, true).show();
    }
    ...
    public static void normal(@NonNull String message, int duration) {
        normal(SDAndroidLib.getContext(), message, duration, null, false).show();
    }
    ...
    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(SDAndroidLib.getContext(), message, duration, icon, true).show();
    }
    ...
    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(SDAndroidLib.getContext(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }
    ...
    public static void warning(@NonNull String message, int duration) {
        warning(SDAndroidLib.getContext(), message, duration, true).show();
    }
    ...
    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(SDAndroidLib.getContext(), message, getDrawable(R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }
    ...
    public static void info(@NonNull String message, int duration) {
        info(SDAndroidLib.getContext(), message, duration, true).show();
    }
    ...
    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(SDAndroidLib.getContext(), message, getDrawable(R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }
    ...
    public static void success(@NonNull String message, int duration) {
        success(SDAndroidLib.getContext(), message, duration, true).show();
    }
    ...
    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(SDAndroidLib.getContext(), message, getDrawable(R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }
