...
public class SDRoundImageView extends ImageView {
    ...
    public SDRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SDRoundImageView, defStyleAttr, 0);
