...
public class SDFlowTagLayout extends ViewGroup {
    ...
    public SDFlowTagLayout(Context context) {
        super(context);
    }

    public SDFlowTagLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SDFlowTagLayout(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(SDFlowTagLayout.this, childView, j);
                        }
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(SDFlowTagLayout.this, new ArrayList<Integer>());
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(SDFlowTagLayout.this, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(SDFlowTagLayout.this, list);
                        }
                    }
                }
            });
