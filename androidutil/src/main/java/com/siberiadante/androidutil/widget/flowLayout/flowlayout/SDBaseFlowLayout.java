 ...
 * </ul>
 */
public class SDBaseFlowLayout extends ViewGroup {
    ...
    public SDBaseFlowLayout(Context context) {
        this(context, null);
    }

    public SDBaseFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SDBaseFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.SDBaseFlowLayout);
        mChildHorizontalSpacing = array.getDimensionPixelSize(
                R.styleable.SDBaseFlowLayout_horizontalSpacing, 0);
        mChildVerticalSpacing = array.getDimensionPixelSize(
                R.styleable.SDBaseFlowLayout_verticalSpacing, 0);
        mGravity = array.getInteger(R.styleable.SDBaseFlowLayout_android_gravity, Gravity.LEFT);
        int maxLines = array.getInt(R.styleable.SDBaseFlowLayout_android_maxLines, -1);
        if (maxLines >= 0) {
            setMaxLines(maxLines);
        }
        int maxNumber = array.getInt(R.styleable.SDBaseFlowLayout_maxNum, -1);
        if (maxNumber >= 0) {
