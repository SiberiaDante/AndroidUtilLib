package com.siberiadante.androidutil.widget.relativelayout;
...
public class SDShapeRelativeLayout extends RelativeLayout {

    private SDRoundViewAttr roundViewAttr;

    public SDShapeRelativeLayout(Context context) {
        this(context, null);
    }

    public SDShapeRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
