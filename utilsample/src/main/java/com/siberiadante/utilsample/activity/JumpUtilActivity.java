...
public class JumpUtilActivity extends BaseActivity {
    ...
    @OnClick({R.id.btn_open_setting, R.id.btn_open_setting_details,
            R.id.btn_open_browser, R.id.btn_open_email, R.id.btn_send_email,
            R.id.btn_start_activity1, R.id.btn_start_activity2, R.id.btn_start_activity3,
            R.id.btn_start_activity4})
