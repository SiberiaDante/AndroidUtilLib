package com.siberiadante.lib.view.likeview;
...
import com.siberiadante.lib.view.likeview.spreadlikeviewbase.RxPorterShapeImageView;
import com.siberiadante.lib.view.likeview.spreadlikeviewbase.RxShineView;
...
public class SDSpreadLikeView extends RxPorterShapeImageView {
    ...
    public SDSpreadLikeView(Context context) {
        super(context);
    ...
    public SDSpreadLikeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initButton(context, attrs);
    }


    public SDSpreadLikeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initButton(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SDSpreadLikeView);
        btnColor = a.getColor(R.styleable.SDSpreadLikeView_d_spread_like_view_color, Color.GRAY);
        btnFillColor = a.getColor(R.styleable.SDSpreadLikeView_d_spread_like_view_fill_color, Color.BLACK);
        shineParams.allowRandomColor = a.getBoolean(R.styleable.SDSpreadLikeView_d_spread_like_view_allow_random_color, false);
        shineParams.animDuration = a.getInteger(R.styleable.SDSpreadLikeView_d_spread_like_view_animation_duration, (int) shineParams.animDuration);
        shineParams.bigShineColor = a.getColor(R.styleable.SDSpreadLikeView_d_spread_like_view_big_color, shineParams.bigShineColor);
        shineParams.clickAnimDuration = a.getInteger(R.styleable.SDSpreadLikeView_d_spread_like_view_click_animation_duration, (int) shineParams.clickAnimDuration);
        shineParams.enableFlashing = a.getBoolean(R.styleable.SDSpreadLikeView_d_spread_like_view_enable_flashing, false);
        shineParams.shineCount = a.getInteger(R.styleable.SDSpreadLikeView_d_spread_like_view_count, shineParams.shineCount);
        shineParams.shineDistanceMultiple = a.getFloat(R.styleable.SDSpreadLikeView_d_spread_like_view_distance_multiple, shineParams.shineDistanceMultiple);
        shineParams.shineTurnAngle = a.getFloat(R.styleable.SDSpreadLikeView_d_spread_like_view_turn_angle, shineParams.shineTurnAngle);
        shineParams.smallShineColor = a.getColor(R.styleable.SDSpreadLikeView_d_spread_like_view_small_color, shineParams.smallShineColor);
        shineParams.smallShineOffsetAngle = a.getFloat(R.styleable.SDSpreadLikeView_d_spread_like_view_small_offset_angle, shineParams.smallShineOffsetAngle);
        shineParams.shineSize = a.getDimensionPixelSize(R.styleable.SDSpreadLikeView_d_spread_like_view_size, shineParams.shineSize);
        a.recycle();
