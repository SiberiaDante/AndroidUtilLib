package com.siberiadante.lib.view.base;
...
public class SDDialog extends Dialog {
    ...
    public SDDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView(Context context) {
        ...
        this.getWindow().setBackgroundDrawableResource(R.drawable.transparent_backgroun);
        mContext = context;
     ...
     */
    public SDDialog(Context context, float alpha, int gravity) {
        super(context);
