 ...
 * RTextView
 * <p>
 * 1. SDTextView 让你从此不再编写和管理大量 selector 文件（这个太可恨了）
 * 2. SDTextView 改造了 drawableLeft/drawableXXX 图片的大小，从此你不在需要使用 LinearLayout + ImageView + TextView 就能够直接实现文字带图片的功能，关键还能设置icon大小
 * 3. SDTextView 能够直接设置各种圆角效果： 四周圆角，某一方向圆角，甚至椭圆，圆形都简单实现。 边框效果，虚线边框都是一个属性搞定
 * 4. SDTextView 不仅能够定义默认状态的背景，边框，连按下/点击状态通通一起搞定
 * 5. SDTextView 按下变色支持：背景色，边框，文字，drawableLeft/xxx （这个赞啊）
 * <p>
 * 原文：https://github.com/RuffianZhong/RTextView
 *
 * @author ZhongDaFeng
 */
public class SDTextView extends AppCompatTextView {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SDTextView);
        //corner
        mCornerRadius = a.getDimensionPixelSize(R.styleable.SDTextView_corner_radius, -1);
        mCornerRadiusTopLeft = a.getDimensionPixelSize(R.styleable.SDTextView_corner_radius_top_left, 0);
        mCornerRadiusTopRight = a.getDimensionPixelSize(R.styleable.SDTextView_corner_radius_top_right, 0);
        mCornerRadiusBottomLeft = a.getDimensionPixelSize(R.styleable.SDTextView_corner_radius_bottom_left, 0);
        mCornerRadiusBottomRight = a.getDimensionPixelSize(R.styleable.SDTextView_corner_radius_bottom_right, 0);
        //border
        mBorderDashWidth = a.getDimensionPixelSize(R.styleable.SDTextView_border_dash_width, 0);
        mBorderDashGap = a.getDimensionPixelSize(R.styleable.SDTextView_border_dash_gap, 0);
        mBorderWidthNormal = a.getDimensionPixelSize(R.styleable.SDTextView_border_width_normal, 0);
        mBorderWidthPressed = a.getDimensionPixelSize(R.styleable.SDTextView_border_width_pressed, 0);
        mBorderWidthUnable = a.getDimensionPixelSize(R.styleable.SDTextView_border_width_unable, 0);
        mBorderColorNormal = a.getColor(R.styleable.SDTextView_border_color_normal, Color.TRANSPARENT);
        mBorderColorPressed = a.getColor(R.styleable.SDTextView_border_color_pressed, Color.TRANSPARENT);
        mBorderColorUnable = a.getColor(R.styleable.SDTextView_border_color_unable, Color.TRANSPARENT);
        //icon
        mIconNormal = a.getDrawable(R.styleable.SDTextView_icon_src_normal);
        mIconPressed = a.getDrawable(R.styleable.SDTextView_icon_src_pressed);
        mIconUnable = a.getDrawable(R.styleable.SDTextView_icon_src_unable);
        mIconWidth = a.getDimensionPixelSize(R.styleable.SDTextView_icon_width, 0);
        mIconHeight = a.getDimensionPixelSize(R.styleable.SDTextView_icon_height, 0);
        mIconDirection = a.getInt(R.styleable.SDTextView_icon_direction, ICON_DIR_LEFT);
        //text
        mTextColorNormal = a.getColor(R.styleable.SDTextView_text_color_normal, getCurrentTextColor());
        mTextColorPressed = a.getColor(R.styleable.SDTextView_text_color_pressed, getCurrentTextColor());
        mTextColorUnable = a.getColor(R.styleable.SDTextView_text_color_unable, getCurrentTextColor());

        //background
        mBackgroundColorNormal = a.getColor(R.styleable.SDTextView_background_normal, 0);
        mBackgroundColorPressed = a.getColor(R.styleable.SDTextView_background_pressed, 0);
        mBackgroundColorUnable = a.getColor(R.styleable.SDTextView_background_unable, 0);
    ...
    public SDTextView setIconNormal(Drawable icon) {
    ...
    public SDTextView setIconPressed(Drawable icon) {
    ...
    public SDTextView setIconUnable(Drawable icon) {
    ...
    public SDTextView setIconSize(int iconWidth, int iconHeight) {
    ...
    public SDTextView setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public SDTextView setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public SDTextView setIconDirection(int iconDirection) {
    ...
    public SDTextView setTextColorNormal(int textColor) {
    ...
    public SDTextView setPressedTextColor(int textColor) {
    ...
    public SDTextView setTextColorUnable(int textColor) {
    ...
    public SDTextView setBorderWidthNormal(int width) {
    ...
    public SDTextView setBorderColorNormal(int color) {
    ...
    public SDTextView setBorderWidthPressed(int width) {
    ...
    public SDTextView setBorderColorPressed(int color) {
    ...
    public SDTextView setBorderWidthUnable(int width) {
    ...
    public SDTextView setBorderColorUnable(int color) {
    ...
    public SDTextView setCornerRadiusTopLeft(float topLeft) {
    ...
    public SDTextView setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public SDTextView setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public SDTextView setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
