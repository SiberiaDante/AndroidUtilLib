...
public class RxShineView extends View {
    ...
    SDSpreadLikeView mRxShineButton;
    private Paint paint;
    ...
    public RxShineView(Context context, final SDSpreadLikeView rxShineButton, ShineParams shineParams) {
        super(context);
    ...
    @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
    public void showAnimation(SDSpreadLikeView rxShineButton) {
    ...
    private void initShineParams(ShineParams shineParams, SDSpreadLikeView rxShineButton) {
