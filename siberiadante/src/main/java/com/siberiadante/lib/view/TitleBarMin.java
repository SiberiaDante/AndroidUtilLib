 ...
 * @Describe： 该类中的部分代码已移植到TitleBar中，此类最终也将废弃，不予维护
 * @Time: 2017/6/30
 * @Email: 994537867@qq.com
 * @GitHub: https://github.com/SiberiaDante
 */

public class TitleBarMin extends ViewGroup implements View.OnClickListener {
    ...
    public TitleBarMin(Context context) {
        super(context);
        init(context);
    }

    public TitleBarMin(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TitleBarMin(Context context, AttributeSet attrs, int defStyleAttr) {
