...
public class SDPhoneUtil {
    ...
    private static PackageInfo getPackageInfo() {
        try {
            return getPackageManager().getPackageInfo(SiberiaDanteLib.getContext().getPackageName(), 0);
    ...
    public static String getDeviceIdIMEI() {
        TelephonyManager tm = (TelephonyManager) SiberiaDanteLib.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getAndroidId() {
        return Settings.Secure.getString(SiberiaDanteLib.getContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void dial(final String phoneNumber) {
        SiberiaDanteLib.getContext().startActivity(SDIntentUtil.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        SiberiaDanteLib.getContext().startActivity(SDIntentUtil.getCallIntent(phoneNumber));
    }
    /**
     * 拨打电话
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        SiberiaDanteLib.getContext().startActivity(SDIntentUtil.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(SiberiaDanteLib.getContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = SiberiaDanteLib.getContext().getContentResolver();
