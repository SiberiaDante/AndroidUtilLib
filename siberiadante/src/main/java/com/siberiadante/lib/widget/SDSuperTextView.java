...
public class SDSuperTextView extends TextView {
 ...
 */
    ...
    public SDSuperTextView(Context context) {
        super(context);
        init(null);
    }

    public SDSuperTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.SDSuperTextView);
            corner = typedArray.getDimension(R.styleable.SDSuperTextView_corner, DEFAULT_CORNER);
            leftTopCornerEnable =
                    typedArray.getBoolean(R.styleable.SDSuperTextView_left_top_corner, false);
            rightTopCornerEnable =
                    typedArray.getBoolean(R.styleable.SDSuperTextView_right_top_corner, false);
            leftBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.SDSuperTextView_left_bottom_corner, false);
            rightBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.SDSuperTextView_right_bottom_corner, false);
            solid = typedArray.getColor(R.styleable.SDSuperTextView_solid, DEFAULT_SOLID);
            strokeWidth = typedArray.getDimension(R.styleable.SDSuperTextView_stroke_width,
                    DEFAULT_STROKE_WIDTH);
            strokeColor =
                    typedArray.getColor(R.styleable.SDSuperTextView_stroke_color, DEFAULT_STROKE_COLOR);
            drawable = typedArray.getDrawable(R.styleable.SDSuperTextView_state_drawable);
            drawableWidth =
                    typedArray.getDimension(R.styleable.SDSuperTextView_state_drawable_width, 0);
            drawableHeight =
                    typedArray.getDimension(R.styleable.SDSuperTextView_state_drawable_height, 0);
            drawablePaddingLeft =
                    typedArray.getDimension(R.styleable.SDSuperTextView_state_drawable_padding_left, 0);
            drawablePaddingTop =
                    typedArray.getDimension(R.styleable.SDSuperTextView_state_drawable_padding_top, 0);
            isShowState = typedArray.getBoolean(R.styleable.SDSuperTextView_isShowState, false);
            stateDrawableMode = typedArray.getInteger(R.styleable.SDSuperTextView_state_drawable_mode,
                    DEFAULT_STATE_DRAWABLE_MODE);
            textStroke = typedArray.getBoolean(R.styleable.SDSuperTextView_text_stroke, false);
            textStrokeColor = typedArray.getColor(R.styleable.SDSuperTextView_text_stroke_color,
                    DEFAULT_TEXT_STROKE_COLOR);
            textFillColor = typedArray.getColor(R.styleable.SDSuperTextView_text_fill_color,
                    DEFAULT_TEXT_FILL_COLOR);
            textStrokeWidth = typedArray.getDimension(R.styleable.SDSuperTextView_text_stroke_width,
                    DEFAULT_TEXT_STROKE_WIDTH);
            autoAdjust = typedArray.getBoolean(R.styleable.SDSuperTextView_autoAdjust, false);
            shaderStartColor =
                    typedArray.getColor(R.styleable.SDSuperTextView_shaderStartColor, 0);
            shaderEndColor =
                    typedArray.getColor(R.styleable.SDSuperTextView_shaderEndColor, 0);
            shaderMode = typedArray.getInteger(R.styleable.SDSuperTextView_shaderMode, 0);
            shaderEnable = typedArray.getBoolean(R.styleable.SDSuperTextView_shaderEnable, false);
            typedArray.recycle();
        }
    }
     ...
     */
    public SDSuperTextView setCorner(float corner) {
        this.corner = corner;
        postInvalidate();
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setSolid(int solid) {
        this.solid = solid;
        postInvalidate();
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setStrokeWidth(float strokeWidth) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setStrokeColor(int strokeColor) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setAdjuster(Adjuster adjuster) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setTextStroke(boolean textStroke) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setTextStrokeColor(int textStrokeColor) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setTextFillColor(int textFillColor) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setTextStrokeWidth(float textStrokeWidth) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setAutoAdjust(boolean autoAdjust) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setLeftTopCornerEnable(boolean leftTopCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setRightTopCornerEnable(boolean rightTopCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setLeftBottomCornerEnable(boolean leftBottomCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setRightBottomCornerEnable(boolean rightBottomCornerEnable) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setDrawable(Drawable drawable) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setDrawable(int drawableRes) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setShowState(boolean showState) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setDrawableWidth(float drawableWidth) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setDrawableHeight(float drawableHeight) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setDrawablePaddingLeft(float drawablePaddingLeft) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setDrawablePaddingTop(float drawablePaddingTop) {
    ...
    /**
     * @param shaderStartColor 设置渐变起始色。需要调用{@link SDSuperTextView#setShaderEnable(boolean)}后才能生效。会触发一次重绘。
     * @return SuperTextView
     */
    public SDSuperTextView setShaderStartColor(int shaderStartColor) {
    ...
    /**
     * @param shaderEndColor 设置渐变结束色。需要调用{@link SDSuperTextView#setShaderEnable(boolean)}后才能生效。会触发一次重绘。
     * @return SuperTextView
     */
    public SDSuperTextView setShaderEndColor(int shaderEndColor) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setShaderMode(int shaderMode) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setShaderEnable(boolean shaderEnable) {
     ...
     * @return SuperTextView
     */
    public SDSuperTextView setFrameRate(int frameRate) {
        if (frameRate > 0) {
    ...
    /**
     * 启动动画。需要设置{@link SDSuperTextView#setAutoAdjust(boolean)}为true才能看到。
     */
    ...
    public static abstract class Adjuster {
         ...
         */
        protected abstract void adjust(SDSuperTextView v, Canvas canvas);
         ...
         */
        public boolean onTouch(SDSuperTextView v, MotionEvent event) {
            return false;
        }
    ...
    public static class DefaultAdjuster extends Adjuster {
        ...
        @Override
        public void adjust(SDSuperTextView v, Canvas canvas) {
            int length = v.length();
