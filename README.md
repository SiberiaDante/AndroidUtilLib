...
## util
* [NetWorkUtil:](https://github.com/SibreiaDante/SiberiaDanteLib/blob/master/siberiadante/src/main/java/com/siberiadante/util/NetWorkUtil.java/"NetWorkUtil")网络连接、类型等
