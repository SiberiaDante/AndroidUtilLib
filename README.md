...
* [TitleBar] :常规的titleBar的封装，一般的titleBar均可([使用说明:siberiadante/src/main/note/note_details_5/TitleBar.md])
## src/main.note
* note-1
    * [Android开发人员必备]
* note-2
...
[使用说明:siberiadante/src/main/note/note_details_5/TitleBar.md]:https://github.com/SiberiaDante/SiberiaDanteLib/blob/master/siberiadante/src/main/note/note_details_5/TitleBar.md
